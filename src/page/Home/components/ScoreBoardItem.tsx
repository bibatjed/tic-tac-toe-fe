    ...
    <Disclosure>
      {({ open }) => (
        <div className="bg-white hover:cursor-pointer flex flex-col justify-center p-2 gap-5 rounded-lg relative">
          <Disclosure.Button className="bg-white hover:cursor-pointer flex flex-row justify-center items-center p-5 gap-5 rounded-lg relative">
            <div className="flex flex-row font-bold items-center gap-0.5">
              <h2 className="text-md md:text-lg font-bold max-w-[150px] truncate">{props.player1.name}</h2>
              <span className="text-green-500 font-bold">({props.player1.wins})</span>
            </div>

            <span className="text-xl md:text-2xl text-red-500 font-extrabold">VS</span>

            <div className="flex flex-row font-bold items-center gap-0.5">
              <h2 className="text-md md:text-lg font-bold max-w-[150px] truncate">{props.player2.name}</h2>
